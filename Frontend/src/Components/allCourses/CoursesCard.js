...
const topics = [
  ...
  { id: 2, route: 'web-development', title: 'WebDevelopment', label: 'Web Development', description: 'Frontend, Backend, Fullstack...', color: '#3498db' },
  ...
  { id: 5, route: 'ai', title: 'ArtificialIntelligence', label: 'Artificial Intelligence', description: 'Everything related to your account: avatar, password, notifications & more.', color: '#f39c12' },
  { id: 6, route: 'ml', title: 'MachineLearning', label: 'Machine Learning', description: 'How to reply to your users using Mediators Inbox.', color: '#9b59b6' },
